...
const titles: Record<string, string> = { overview: "Genel Bakış", "image-generation": "Görsel Üret", "video-generation": "Video Üret", publishing: "Paylaşım Planı", accounts: "Sosyal Medya Hesapları", pinterest: "Pinterest", settings: "Proje Ayarları" };
